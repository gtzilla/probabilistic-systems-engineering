(function () {
  function initMobileHeader(header) {
    ...
    function setMenu(open) {
      ...
      document.body.classList.toggle('mobile-scroll-lock', open);
      if (open) {
    ...
    function applyScrollState() {
      if (!mq.matches) {
        document.body.classList.remove('mobile-header-compact', 'mobile-header-hidden', 'mobile-menu-open', 'mobile-scroll-lock');
